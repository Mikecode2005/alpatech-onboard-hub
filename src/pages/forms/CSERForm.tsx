...
const CSERForm = () => {
  const { saveCSERForm } = useAppState();
  ...
  const onSubmit = () => {
    ...
    saveCSERForm(form);
    toast({ title: "CSE&R Training Form Submitted Successfully!" });
  };

  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        <title>CSE&R Training Form | Alpatech</title>
        <meta name="description" content="Pre-training engagement assessment form for Confined Space Entry & Rescue training." />
      </Helmet>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-center">
              ...
              <div className="text-lg font-normal mt-2">(CSE&R TRAINING)</div>
              <div className="text-sm font-normal text-muted-foreground mt-1">Confined Space Entry & Rescue</div>
            </CardTitle>
          </CardHeader>
            ...
            <section className="space-y-4">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  />
                  <Label htmlFor="healthCond">Do you have any health condition or other reasons that you consider not appropriate for confined space entry?</Label>
                </div>
                ...
                <div className="grid gap-2">
                  <Label>Do you have any other personal or confidential information about your health or concerns about working in confined spaces?</Label>
                  <Textarea 
          ...
          <CardFooter>
            <Button variant="hero" onClick={onSubmit} className="w-full">Submit CSE&R Training Form</Button>
          </CardFooter>
        </Card>
      </div>
    </div>
