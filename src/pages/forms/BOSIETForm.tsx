...
const BOSIETForm = () => {
  const { saveBOSIETForm } = useAppState();
  ...
  const onSubmit = () => {
    ...
    saveBOSIETForm(form);
    toast({ title: "BOSIET Training Form Submitted Successfully!" });
  };

  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        <title>BOSIET Training Form | Alpatech</title>
        <meta name="description" content="Pre-training engagement assessment form for BOSIET training." />
      </Helmet>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-center">
              ...
              <div className="text-lg font-normal mt-2">(BOSIET TRAINING)</div>
            </CardTitle>
          </CardHeader>
          ...
          <CardFooter>
            <Button variant="hero" onClick={onSubmit} className="w-full">Submit BOSIET Training Form</Button>
          </CardFooter>
        </Card>
      </div>
    </div>
